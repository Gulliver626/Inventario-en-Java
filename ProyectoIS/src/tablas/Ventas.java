...
public class Ventas extends javax.swing.JFrame {
    ...
    public Ventas() {
        initComponents();
        jtVentas.getTableHeader().setDefaultRenderer(new HeaderColor());
        ...
        try {
            ...
            String sql = "Select id_venta, id_salida, id_producto, comprador, responsable, cantidad, precio_venta, fecha_venta FROM ventas";
    ...
    private void initComponents() {
        ...
        CBoxFiltro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Id_venta", "Id_salida", "Id_producto", "Comprador", "Responsable", "Cantidad", "Precio_venta", "Fecha_venta", " " }));
        ...
        jtVentas.setBackground(new java.awt.Color(51, 51, 51));
        ...
        jtVentas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id_ventas            |", "Id_salida            |", "Id_producto         |", "Comprador            |", "Responsable          |", "Cantidad           |", "Precio_venta        |", "Fecha_venta      |"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.String.class, java.lang.String.class, java.lang.Integer.class, java.lang.Double.class, java.lang.Integer.class
            };
        ...
        jtVentas.setGridColor(new java.awt.Color(102, 102, 102));
        jtVentas.setIntercellSpacing(new java.awt.Dimension(0, 0));
        jtVentas.setRowHeight(20);
        jtVentas.setSelectionBackground(new java.awt.Color(39, 59, 89));
        jtVentas.setSelectionForeground(new java.awt.Color(51, 51, 51));
