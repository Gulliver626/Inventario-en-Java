...
public class Salidas extends javax.swing.JFrame {
    ...
    public Salidas() {
        initComponents();
        jtSalidas.getTableHeader().setDefaultRenderer(new HeaderColor());
        setLocationRelativeTo(null);
        desplace = new Desface();

        try {
            DefaultTableModel modelo = new DefaultTableModel();
            jtSalidas.setModel(modelo);
            ...
            String sql = "Select id_salida, id_producto, Producto, fecha_entrada, fecha_salida, motivo, usuario_responsable, cantidad FROM salidas ";
    ...
    private void initComponents() {
        ...
        CBoxFiltro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Id_salida", "Id_producto", "Producto", "Fecha_entrada", "Fecha_salida", "Motivo", "Usuario_responsable", "Cantidad", " " }));
        ...
        jtSalidas.setBackground(new java.awt.Color(51, 51, 51));
        jtSalidas.setForeground(new java.awt.Color(255, 255, 255));
        jtSalidas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id_salida              |", "Id_producto           |", "Producto              |", "Fecha_entrada       |", "Fecha_salida         |", "Motivos           |", "Usuario_responsable  |", "Cantidad            |"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.String.class, java.lang.Double.class
            };
        ...
        jtSalidas.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jtSalidas.setFocusable(false);
        jtSalidas.setGridColor(new java.awt.Color(102, 102, 102));
        jtSalidas.setIntercellSpacing(new java.awt.Dimension(0, 0));
        jtSalidas.setRowHeight(20);
        jtSalidas.setSelectionBackground(new java.awt.Color(39, 59, 89));
        jtSalidas.setSelectionForeground(new java.awt.Color(51, 51, 51));
