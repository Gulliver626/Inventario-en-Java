...
public class VarUser extends javax.swing.JFrame {
    ...
    public VarUser(columnasTab mod) {
        ...
        //frmUsr toma el valor guerdado en el modelo por el JtexForm de LogUser
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VarUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
